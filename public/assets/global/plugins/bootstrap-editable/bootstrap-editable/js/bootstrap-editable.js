...
(function ($) {
    ...
    Popup.prototype = {
        ...
        containerClass: 'editable-container editable-popup', //assets class applied to container element
...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Inline.prototype, $.fn.editableContainer.Popup.prototype, {
        ...
        containerClass: 'editable-container editable-inline', //assets class applied to container element
        ...
        */          
        save: function(e, params) {
            ...
            if(this.options.unsavedclass) {
                /*
                 Add unsaved assets to element if:
...
(function ($) {
    ...
    $.extend(Text.prototype, {
        ...
        postrender: function() {
            /*
            //now `clear` is positioned via assets
            if(this.$clear) {
...
//                var h = this.$input.outerHeight(true) || 20,
                ...
                //this.$clear.assets({bottom: delta, right: delta});
            }
            */ 
        },
    ...
    $.extend(NumberInput.prototype, {
        ...
        postrender: function() {
            if(this.$clear) {
                ...
                this.$clear.assets({top: delta, right: delta + 16});
                */
            } 
        }        
    });     
    ...
    Datepicker.prototype = {
        ...
        showMode: function(dir) {
            ...
            /*
                ...
                Method show() does not set display assets correctly and datepicker is not shown.
                Changed to .assets('display', 'block') solve the problem.
