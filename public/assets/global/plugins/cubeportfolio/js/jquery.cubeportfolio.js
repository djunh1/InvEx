...
(function($, window, document, undefined) {
    ...
    function CubePortfolio(obj, options, callback) {
        ...
        if (t.options.caption) {
            ...
            // .cbp-caption-active is used only for assets
            // so it will not generate a big assets from sass if a caption is set
    ...
    $.extend(CubePortfolio.prototype, {
        ...
        gridAdjust: function() {
            ...
            if (t.options.gridAdjustment === 'responsive') {
                ...
                // for the current grid width. This is usefull for the styles defined in assets
    ...
    var popup = {
        ...
        init: function(cubeportfolio, type) {
            ...
            if (type === 'singlePageInline') {
                ...
                // create markup, assets and add events for SinglePageInline
            ...
            // create markup, assets and add events for lightbox and singlePage
            t.createMarkup();
        ...
        /**
         * Create markup, assets and add events
         */
